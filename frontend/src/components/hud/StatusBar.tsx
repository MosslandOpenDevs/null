...
export function StatusBar() {
  ...
  return (
    <>
      <div className="relative h-8 flex items-center justify-between px-4 bg-void-light border-b border-hud-border font-mono text-[10px] uppercase tracking-[0.2em] text-hud-muted overflow-hidden scanline-sweep">
