...
OLLAMA_ROLE_MODEL_MAP: dict[str, str] = {
    "genesis_architect": "qwen3:30b",
    "main_debater": "qwen3:30b",
    "reaction_agent": "qwen3:30b",
    "chaos_joker": "qwen3:30b",
    "searcher": "qwen3:30b",
    "librarian": "qwen3:30b",
    "translator": "qwen3:30b",
    "post_writer": "qwen3:30b",
    "wiki_writer": "qwen3:30b",
}
